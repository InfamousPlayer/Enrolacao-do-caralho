...
function draw() {
  ...
  if (retMovendo.x - retFixo.x < retFixo.width / 2 + retMovendo.width / 2&&retFixo.x - retMovendo.x < retMovendo.width / 2 + retFixo.width / 2&&
    retMovendo.y - retFixo.y < retFixo.height / 2 + retMovendo.height / 2&&retFixo.y - retMovendo.y < retMovendo.height / 2 + retFixo.height / 2 ) {
